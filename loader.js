// from https://raw.githubusercontent.com/AssemblyScript/assemblyscript/master/lib/loader/index.js
window.loader = (function(exports) {
  'use strict';
  ...
  function postInstantiate(baseModule, instance) {
    ...
    function __allocArray(id, values) {
      ...
      if (info & VAL_MANAGED)
        for (let i = 0; i < length; ++i) retain(values[i]);
      return arr;
    }
    ...
    function __getArrayView(arr) {
      ...
      return getView(align, info & VAL_SIGNED, info & VAL_FLOAT).slice(
        (buf >>>= align),
        buf + length
      );
    }
